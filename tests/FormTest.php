...
class FormTest extends PHPUnit_Framework_TestCase {
	public function testIdFalse(){
		$mock = new MockLayout();
		$form = Form::create(false, function($f){
			$f->textField('foo');
		}, ['layout' => $mock]);
		$this->assertEquals(null, $mock->form_id, "ID as false should not set id at all");
		$this->assertArrayHasKey('foo', $mock->field);
		$this->assertStringMatchesFormat('_Form_Field_%d_foo', $mock->field['foo']->attribute('id'), "Field ID should be autogenerated if parent form is missing ID");
	}
